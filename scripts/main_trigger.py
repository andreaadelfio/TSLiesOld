...
def run_trigger_ffnn(inputs_outputs, y_cols, y_cols_raw, y_cols_pred, x_cols):
    ...
    merged_anomalies_list = Trigger().trigger(tiles_df, y_cols, y_cols_pred, threshold=5)
    ...
    Plotter(df = merged_anomalies_list).plot_anomalies(support_vars, tiles_df, y_cols, y_cols_pred)
