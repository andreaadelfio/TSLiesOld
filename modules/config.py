...
DATA_LATACD_INPUT_FOLDER_NAME = os.path.join(DATA_FOLDER_NAME, 'LAT_ACD/newRuns_v2')

# DATA_LATACD_FOLDER_NAME = os.path.join(DATA_FOLDER_NAME, 'LAT_ACD/Dec23-Feb24 output runs')
DATA_LATACD_FOLDER_NAME = os.path.join(DATA_FOLDER_NAME, 'LAT_ACD/Feb24-Jul24 output runs')
