...
def fetch_goes_data(tstart, tend):
    """
...
if __name__ == "__main__":
    file_goes = fetch_goes_data('2024-02-16 00:00:00', '2024-02-24 00:00:00')
    df = find_goes_data(file_goes)
    print(df.head())
